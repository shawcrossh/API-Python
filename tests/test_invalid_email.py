...
def test_email_missing_atsign(api_request_context: APIRequestContext) -> None:
    data = {
      "description": "",
      ...
      "first_name": "test",
      "last_name": "test",
      "email_address": "heatherfuzablesoftware.com",
    ...
    # Test results
    assert first_row.request_email == "heatherfuzablesoftware.com"
