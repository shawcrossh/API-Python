...
def test_create_new_lead(api_request_context: APIRequestContext) -> None:
    data = {
      "description": "",
    ...
    assert response.get('is_validation_success') is True
    ...
    bigquery_client = bigquery.Client(project='testing.com', credentials=credentials)
    ...
    assert first_row.response_response_result == "success"
