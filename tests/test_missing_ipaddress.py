...
def test_ip_address_missing(api_request_context: APIRequestContext) -> None:
    data = {
      "description": "",
    ...
    # no way to query because lead_id will not be returned
    assert 'lead_id' not in response
